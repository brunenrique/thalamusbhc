...
//
// A lógica de renderização condicional de guias (TabsBar e conteúdo da guia) será
// implementada em src/app/(app)/patients/[id]/page.tsx, dentro da aba "O Coração Clínico".
//
