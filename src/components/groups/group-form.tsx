...
export default function GroupForm({ initialData, groupId }: GroupFormProps) {
  ...
  async function onSubmit(data: GroupFormValues) {
    setIsLoading(true);
    // console.log("Dados do Grupo (Simulado):", { id: groupId, ...data }); // Debug log removed

    // TODO: Simular adição/bloqueio na agenda principal
    // Em uma aplicação real, isso dispararia uma função para criar agendamentos recorrentes
    // ou um evento de bloqueio na agenda do psicólogo.
    // Por agora, apenas um toast indicando a ação.
