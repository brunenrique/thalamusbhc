...
const mockAuditLogs = [
  {
    id: 'log1',
    timestamp: '2024-07-21T10:05:15Z',
    user: 'admin@psiguard.com',
    action: 'Login de Usuário',
    details: 'Login bem-sucedido do IP 192.168.1.10',
    entity: 'Usuário',
    entityId: 'admin001',
  ...
  },
  {
    ...
    user: 'dr.silva@psiguard.com',
    action: 'Prontuário Visualizado',
    details: 'Visualizou prontuário de Alice W.',
    entity: 'Paciente',
    entityId: 'pat001',
    severity: 'Informativo',
  },
  {
    ...
    user: 'secretaria@psiguard.com',
    action: 'Agendamento Criado',
    details: 'Novo agendamento para Bob B. em 2024-07-28',
    entity: 'Agendamento',
    entityId: 'appt015',
    severity: 'Informativo',
  },
  {
    ...
    details: "Usuário 'novo.psico@example.com' aprovado por admin@psiguard.com",
    entity: 'Usuário',
    entityId: 'usr123',
    severity: 'Médio',
  },
  {
    id: 'log5',
    timestamp: '2024-07-20T09:30:45Z',
    user: 'desconhecido@externo.com',
    action: 'Tentativa de Login Falhou',
    details: 'Credenciais inválidas do IP 203.0.113.45',
    entity: 'Sistema',
    entityId: null,
    severity: 'Alto',
  },
  {
    id: 'log6',
    timestamp: '2024-07-22T08:00:10Z',
    user: 'dr.jones@psiguard.com',
    action: 'Configurações Atualizadas',
    details: 'Alterou a duração padrão da sessão para 60 minutos.',
    entity: 'Configurações',
    entityId: 'schedule_settings',
    severity: 'Médio',
  },
  {
    id: 'log7',
    ...
    user: 'admin@psiguard.com',
    action: 'Backup Manual Iniciado',
    details: 'Backup completo dos dados iniciado manualmente.',
    entity: 'Sistema',
    entityId: null,
    severity: 'Informativo',
  },
  {
    ...
    user: 'dr.silva@psiguard.com',
    action: 'Nota de Sessão Deletada',
    details: 'Nota da sessão de 2024-07-15 para Charlie B. foi deletada.',
    entity: 'Nota de Sessão',
    entityId: 'sn005',
    severity: 'Alto',
  },
];
...
export default function AuditTrailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <CardDescription>
        Monitore e rastreie todas as atividades significativas do sistema, modificações de dados e
        ações de usuários para garantir a segurança, conformidade e responsabilidade.
      </CardDescription>
        ...
        <CardHeader>
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-4">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Buscar logs (ex: email, ação, IP, ID da entidade)"
                className="pl-8"
              />
            </div>
                  ...
                  {mockAuditLogs.map((log) => (
                    <TableRow key={log.id} className="hover:bg-muted/20">
                      <TableCell className="text-xs whitespace-nowrap">
                        {format(new Date(log.timestamp), 'Pp', { locale: ptBR })}
                      </TableCell>
                      <TableCell className="text-xs flex items-center gap-1.5">
                        {log.user === 'Sistema' || log.user.includes('desconhecido') ? (
                      ...
                      <TableCell>
                        <Badge
                          variant={severityMap[log.severity as LogSeverity]?.variant || 'outline'}
